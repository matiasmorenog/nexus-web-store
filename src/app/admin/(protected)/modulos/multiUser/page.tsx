...
export default async function AdminMultiUserPage() {
  ...
  const canManage = canManageStoreUsers(getAdminAccessContext(session));
  ...
  return (
    <div className="space-y-8">
      <AdminDashboardReveal index={0}>
        <AdminPageHeader
          title="Multi-usuario"
          description="Invitá usuarios con rol administrador, vendedor, depósito o solo lectura."
        />
