...
export function VapeBrandWordmark({
  storeName,
  size = "md",
  className = "",
}: VapeBrandWordmarkProps) {
  ...
  return (
    <span className={cn("inline-flex items-center", s.gap, className)}>
      ...
      <span
        className={cn(
          "font-vape-display font-bold tracking-[0.16em] text-[var(--brand-primary-light,#f0f0f5)]",
          s.text,
        )}
      >
        {prefix}
