...
export function VapeJungleNightBackdrop({ className, subtle = false }: BackdropProps) {
  return (
    <div
...
export function VapeHeroNatureDecor() {
  return <VapeJungleNightBackdrop />;
}

/** Fondo fijo para toda la home vape. */
export function VapeJunglePageAtmosphere() {
  return (
    <div
      className="pointer-events-none fixed inset-0 -z-10 overflow-hidden"
      aria-hidden
    >
      <VapeJungleNightBackdrop subtle />
    </div>
  );
}
